...
public class MenuPrincipal implements Screen {
	...
	public void Preferencias(){
		...
		if(preferenciasValidacion.get().toString().equals("{}")){
			...
			preferenciasHeroes.putString("2","2-Althalas-Mago-0-100-Largo-2-0-40-1-0-1-1-0-2-1-Uno de los guardianes de la luz, acabó sus estudios en el Circulo de Hechiceros y se unio en la lucha contra la oscuridad-mago.png-mago.png");
			preferenciasHeroes.putString("3","3-Orina-Arquero-70-0-Largo-3-0-50-1-0-1-1-0-3-1-Dejó su pueblo para salvar la luz del mundo-arquero.png-arquero-png");
			preferenciasHeroes.flush();
			preferenciasNiveles.putString("1","1-Tuorial-Emprende la nueva aventura-1,2-100-1000-1-nivel 1.png-JUGANDO");
