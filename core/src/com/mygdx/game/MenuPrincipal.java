...
public class MenuPrincipal implements Screen {
	...
	public void Preferencias(){
		...
		//if(!preferenciasValidacion.get().toString().equals("{}")){
			...
			preferenciasHeroes.putString("1","1-Ehtoas-Guerrero-100-0-Corto-2-0-100-2-0-1-1-0-1-1-Uno de los guardianes de la luz, su propósito es ayudar a la gente y salvar la mayor cantidad de inocentes posibles-Glad.png-Glad.png-518,173");
			...
			preferenciasHeroes.putString("3","3-Orina-Arquero-70-0-Largo-3-0-50-2-0-1-1-0-3-1-Dejó su pueblo para salvar la luz del mundo-arquero_caminando.png-arquero.png-346,173");
			...
			preferenciasEnemigos.putString("1","1-crawler-500-2-2-10-corto-uno de los peones de Cthulhu, enviado a encontrar los cristales de luz-crawler.png-crawler_caminando.png-346,87-crawler_atacando.png-518,87");
			preferenciasEnemigos.putString("2","2-soulEater-800-1-2-15-corto-enviado de la oscuridad a arrasar con la vida orgánica del planeta-soulEater.png-soulEater_caminando.png-346,173-soulEater_atacando-518,87");
