...
public class MenuPrincipal implements Screen {
	...
	public void Preferencias(){
		...
		//if(!preferenciasValidacion.get().toString().equals("{}")){
			...
			preferenciasHeroes.putString("2","2-Althalas-Mago-0-100-Largo-2-0-40-2-0-1-1-0-2-1-Uno de los guardianes de la luz, acabó sus estudios en el Circulo de Hechiceros y se unio en la lucha contra la oscuridad-mago_caminando.png-mago.png-346,173-mago_atacando.png");
